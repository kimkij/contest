...
<body>
    ...
    <nav class="navbar">
        ...
        <a href="https://github.com/contest-lab/contest" target="_blank" class="btn-github">
    ...
    <div class="container">
        ...
        <footer class="footer">
            ...
            <p>분석 파이프라인 및 데이터 소스코드: <a href="https://github.com/contest-lab/contest" target="_blank">github.com/contest-lab/contest</a></p>
        </footer>
