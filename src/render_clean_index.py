...
<body>
        ...
        <div class="nav-inner">
            ...
            <ul class="nav-menu" id="navMenu">
                ...
                <li style="margin-top: 8px; padding-top: 8px; border-top: 1px solid rgba(255,255,255,0.1);" class="mobile-only">
                    <a href="https://github.com/kimkij/contest/blob/main/notebooks/low_floor_bus_equity_analysis.ipynb" target="_blank" rel="noopener noreferrer" style="color: #93c5fd;">
                        📓 분석 노트북 (.ipynb)
                    </a>
                </li>
                <li class="mobile-only">
                    <a href="https://github.com/kimkij/contest/tree/main/src" target="_blank" rel="noopener noreferrer" style="color: #cbd5e1;">
                        💻 Python 소스코드 (src/)
                    </a>
                </li>
            </ul>
            ...
            <div class="nav-actions">
                <a href="https://github.com/kimkij/contest/blob/main/notebooks/low_floor_bus_equity_analysis.ipynb" target="_blank" rel="noopener noreferrer" class="btn-code primary">
                    📓 분석 노트북 (.ipynb)
                </a>
                <a href="https://github.com/kimkij/contest/tree/main/src" target="_blank" rel="noopener noreferrer" class="btn-code">
    ...
    <main class="container">
        ...
        <footer class="footer">
            ...
            <p>
                분석 소스코드 디렉토리: <a href="https://github.com/kimkij/contest/tree/main/src" target="_blank" rel="noopener noreferrer">github.com/kimkij/contest/tree/main/src</a> | 
                분석 노트북: <a href="https://github.com/kimkij/contest/blob/main/notebooks/low_floor_bus_equity_analysis.ipynb" target="_blank" rel="noopener noreferrer">low_floor_bus_equity_analysis.ipynb</a>
            </p>
